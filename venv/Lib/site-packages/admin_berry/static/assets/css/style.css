...
.btn-secondary {
  --bs-btn-color: #ffffff;
  --bs-btn-bg: #4BB649;
  --bs-btn-border-color: #008E50;
  --bs-btn-hover-color: #ffffff;
  --bs-btn-hover-bg: #008E50;
  --bs-btn-hover-border-color: #008E50;
  --bs-btn-focus-shadow-rgb: 125, 52, 244;
  --bs-btn-active-color: #ffffff;
  --bs-btn-active-bg: #008E50;
  --bs-btn-active-border-color: #008E50;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #ffffff;
  --bs-btn-disabled-bg: #008E50;
  --bs-btn-disabled-border-color: #008E50;
}
...
.dropdown-menu {
  ...
  --bs-dropdown-link-hover-bg: #D8E8C3;
  --bs-dropdown-link-active-color: #2689E2;
  --bs-dropdown-link-active-bg: #D8E8C3;
...
.text-bg-primary {
  ...
  background-color: RGBA(0, 142 , 80, var(--bs-bg-opacity, 1)) !important;
}
...
.error-card .error-image-block .img-404.error-text {
  -webkit-animation: 3s ease-in-out 0s infinite normal none running bounce;
...
.error-card .error-image-block .img-404.error-secondary {
  -webkit-animation: 12s ease-in-out 0s infinite normal none running wings;
...
.construction-card .construction-image-block .img-block {
  ...
  left: 0;
  width: 100%;
  -webkit-animation: 10s ease-in-out 0s infinite normal none running blink;
...
.construction-card .construction-image-block .img-main {
  ...
  left: 0;
  width: 100%;
  -webkit-animation: 5s ease-in-out 0s infinite normal none running bounce;
...
.soon-card .soon-image-block .img-soon.soon-secondary, .soon-card .soon-image-block .img-soon.soon-primary {
  -webkit-animation: wings 5s ease-in-out infinite;
